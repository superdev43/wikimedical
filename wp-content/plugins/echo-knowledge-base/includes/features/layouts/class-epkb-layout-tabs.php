...
class EPKB_Layout_Tabs extends EPKB_Layout {
	...
	public function generate_kb_main_page() {
		...
		<div id="epkb-main-page-container" class="<?php echo $main_container_class; ?> <?php echo method_exists( 'EPKB_Utilities', 'get_active_theme_classes' ) ? EPKB_Utilities::get_active_theme_classes( 'mp' ) : ''; ?>">
	...
	private function display_main_page_content( $active_cat_id ) {
		...
		foreach ( $this->category_seq_data as $tab_category_id => $box_categories_array ) {
			...
			<div <?php echo $class1; ?> <?php echo $style_6; ?>> <?php
				...
				$this->check_top_categories_empty( $tab_category_id, $style3, $class0, $class_section_head, $style_section_head, $style5 );
	...
	*/
	 ...
	 * @param $style3
	 * @param $class0
	 * @param $class_section_head
	 * @param $style_section_head
	 * @param $style5
	 */
    private function check_top_categories_empty( $tab_category_id, $style3, $class0, $class_section_head, $style_section_head, $style5 ) {
	    ...
	    if ( ! EPKB_Utilities::is_new_user( '8.1.0' ) || ! current_user_can( EPKB_Admin_UI_Access::get_author_capability() ) ) {
		    return;
	    }
	    ...
	    <section id="0" <?php echo $class0 . ' ' . $warning_style; ?> >
		    ...
		    <div <?php echo $class_section_head . ' ' . $style_section_head; ?> >
			    ...
			    <!-- Category Name + Icon -->
			    <div class="epkb-category-level-2-3 epkb-category--top-cat-icon" <?php echo $style3; ?> >
