...
abstract class EPKB_Editor_Config_Base {
	...
	*/
	...
	// config for current page: kb_config
	...
	public function __construct( ) {
		...
		$this->setting_zones = self::apply_defaults_to_setting_zones( $this->config, $this->setting_zones, $this->specs, $this->unset_settings, $this->page_type );
	}

	public static function apply_defaults_to_setting_zones( $config, $setting_zones, $field_specification, $unset_settings = [], $page_type = '' ) {
