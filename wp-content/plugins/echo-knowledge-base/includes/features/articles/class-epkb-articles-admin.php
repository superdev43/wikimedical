	...
	public function update_articles_sequence( $kb_id ) {
		...
		foreach ( $all_kb_terms as $term ) {
            ...
            switch ( $article_order_method ) {
                case 'created-date': $articles = $db->get_published_articles_by_sub_or_category( $kb_id, $term->term_id ); break;
                case 'modified-date': $articles = $db->get_published_articles_by_sub_or_category( $kb_id, $term->term_id, 'modified' ); break;
                // for 'user-sequenced' use default for now otherwise default is 'alphabetical-title'
                default: $articles = $db->get_published_articles_by_sub_or_category( $kb_id, $term->term_id, 'title' ); break;
            }
