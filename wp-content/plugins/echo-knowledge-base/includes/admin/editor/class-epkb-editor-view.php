...
class EPKB_Editor_View {
			...
			<div class="eckb-bottom-notice-message eckb-bottom-notice-message--center-aligned">
				<div class="contents">
					<span class="error white-box">
						<h4><?php _e( 'The frontend Editor is not loading.', 'echo-knowledge-base' ); ?></h4>
			...
			<div class="epkb-editor-settings-control-container epkb-editor-settings-control-type-image-select epkb-editor-settings-control-type-image-select--themes">
				<label class="epkb-editor-settings-control-image-select" data-name="templates_for_kb">
					...
					<div class="epkb-editor-settings-control-image-select--label">
						...
						<span><?php printf( esc_html__( 'Let the theme %s control page structure', 'echo-knowledge-base' ), '<br>' ); ?>
						</span>
				...
				<label class="epkb-editor-settings-control-image-select" data-name="templates_for_kb">
					...
					<div class="epkb-editor-settings-control-image-select--label">
						...
						<span><?php printf( esc_html__( 'Let the KB %s control page structure', 'echo-knowledge-base' ), '<br>' ); ?>
						</span>
                        <div class="epkb-editor-settings-accordeon-item__description-line">
	...
	private static function frontend_editor_page( ) {
		...
		<html <?php language_attributes(); ?>>
			...
			<body <?php body_class( 'epkb-editor-' . $page_type ); ?>><?php
	...
	public static function error_can_not_load() {
		EPKB_HTML_Forms::notification_box_top( [ 'type' => 'error', 'title' => __( 'Cannot open frontend Editor', 'echo-knowledge-base' ), 'desc' =>  __( 'Cannot load frontend Editor on this page.', 'echo-knowledge-base' ) ] );
	}
	...
	public static function error_user_not_logged_in() {
		...
		EPKB_HTML_Forms::notification_box_top( [ 'type' => 'error', 'title' => __( 'Cannot open frontend Editor', 'echo-knowledge-base' ), 'desc' => __( 'Your login has expired.', 'echo-knowledge-base' ) . ' ' . $link ]);
	}

	public static function error_no_permissions() {
		EPKB_HTML_Forms::notification_box_top( [ 'type' => 'error', 'title' => __( 'Cannot open frontend Editor', 'echo-knowledge-base' ), 'desc' =>  __( 'You do not have permission to edit this knowledge base.', 'echo-knowledge-base' ) ] );
	}
}