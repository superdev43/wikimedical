...
function epkb_add_plugin_menus() {
	...
	// KB Menu
	add_submenu_page( 'edit.php?post_type=' . $post_type_name, __( 'Need Help - Echo Knowledge Base', 'echo-knowledge-base' ), __( 'Need Help?', 'echo-knowledge-base' ),
...
function epkb_add_page_tabs() {
	...
	switch ( $screen_id ) {
		...
		case 'edit-EKB_SCREEN_category':                // Categories page
			EPKB_HTML_Admin::admin_header( EPKB_HTML_Admin::admin_header_content( $kb_config ), 'left' );
			return;
