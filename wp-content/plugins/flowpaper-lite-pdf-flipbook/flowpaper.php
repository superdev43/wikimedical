...
define('FLOWPAPER_PLUGIN_VERSION', '1.9.6');
...
function flowpaper_plugin_add_shortcode_cb( $atts, $content="" ) {
    ...
    if($linkEmbed){
        ...
        $html .= ' seamless="seamless" style="margin-bottom:0;display:block;">Your browser does not seem to support iframes. <a href="' . $pdfUrl . '" target="_blank">Click here to read this PDF</a>.</iframe>'."\n";
