...
class EPKB_KB_Handler {
	...
	public static function add_new_knowledge_base( $new_kb_id, $new_kb_main_page_title='', $new_kb_main_page_slug='', $kb_main_page_layout='' ) {
		...
		// not needed EPKB_Articles_CPT_Setup::register_custom_post_type( $kb_config, $new_kb_id );
	...
	private static function create_sample_categories_and_articles( $new_kb_id, $kb_main_page_layout ) {
	...
	private static function find_current_kb_id() {
		...
		// try to find KB ID from Frontend Editor AJAX call (on apply changes)
