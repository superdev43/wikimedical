...
class EPKB_KB_Config_Specs {
	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			// Access to Frontend Editor (write)
			...
			'admin_eckb_access_order_articles_write' => array(
				...
				'min'         => '3',
				'allowed_access'  => array( EPKB_Admin_UI_Access::EPKB_WP_EDITOR_CAPABILITY ),
				'default'     => EPKB_Utilities::is_amag_on( true ) ? EPKB_Admin_UI_Access::EPKB_ADMIN_CAPABILITY : EPKB_Admin_UI_Access::EPKB_WP_EDITOR_CAPABILITY
			),
			...
			'admin_eckb_access_search_analytics_read' => array(
				...
				'default'     => EPKB_Utilities::is_amag_on( true ) ? EPKB_Admin_UI_Access::EPKB_ADMIN_CAPABILITY : EPKB_Admin_UI_Access::EPKB_WP_AUTHOR_CAPABILITY
			),
