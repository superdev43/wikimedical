...
class EPKB_Editor_Utilities {
	 ...
	 * @return array
	 */
	public static function get_editor_urls( $kb_config, $main_page_zone_name='', $article_page_zone_name='', $archive_page_zone_name='' ) {
	...
	/**
	 * Return frontend Editor URL for given page type
	 * @param $page_type
	 * @param $zone_name
	...
	/**
	 * Determine what page are we editing in the frontend Editor
	 * @return string
	 */
