...
class EPKB_Layout_Categories extends EPKB_Layout {
	...
	public function generate_kb_main_page() {
		...
		<div id="epkb-main-page-container" class="epkb-css-full-reset epkb-categories-template <?php echo method_exists( 'EPKB_Utilities', 'get_active_theme_classes' ) ? EPKB_Utilities::get_active_theme_classes( 'mp' ) : ''; ?>">
