...
class EPKB_Admin_UI_Access {
	...
	public static function get_access_boxes( $kb_config ) {
		...
		$config_html = new EPKB_KB_Config_Elements();
		$kb_id = $kb_config['id'];
		...
		$boxes_config[] =
			array(
				...
				'html' => $config_html->radio_buttons_vertical( array(
					'name'          => 'admin_eckb_access_frontend_editor_write',
					'radio_class'   => 'epkb-admin__radio-button-wrap',
					'return_html'   => true,
					'current'       => self::is_capability_in_allowed_list( $kb_config['admin_eckb_access_frontend_editor_write'], $kb_id )
		...
		$boxes_config[] =
			array(
				...
				'html' => $config_html->radio_buttons_vertical( array(
					...
					'radio_class'   => 'epkb-admin__radio-button-wrap',
					'return_html'   => true,
					'current'       => self::is_capability_in_allowed_list( $kb_config['admin_eckb_access_order_articles_write'], $kb_id )
		...
		$boxes_config[] =
			array(
				...
				'html' => $config_html->radio_buttons_vertical( array(
					...
					'radio_class'   => 'epkb-admin__radio-button-wrap',
					'return_html'   => true,
					'current'       => self::is_capability_in_allowed_list( $kb_config['admin_eckb_access_search_analytics_read'], $kb_id )
		...
		$boxes_config[] =
			array(
				...
				'html' => $config_html->radio_buttons_vertical( array(
					...
					'radio_class'   => 'epkb-admin__radio-button-wrap',
					'return_html'   => true,
					'current'       => self::is_capability_in_allowed_list( $kb_config['admin_eckb_access_need_help_read'], $kb_id )
		...
		$boxes_config[] =
			array(
				...
				'html' => $config_html->radio_buttons_vertical( array(
					...
					'radio_class'   => 'epkb-admin__radio-button-wrap',
					'return_html'   => true,
					'current'       => self::is_capability_in_allowed_list( $kb_config['admin_eckb_access_addons_news_read'], $kb_id )
	...
	public static function is_user_allowed_unfiltered_html() {
		return current_user_can( 'unfiltered_html' ) || current_user_can( self::get_admin_capability() );
	}
}
