...
class EPKB_Layout_Basic extends EPKB_Layout {
	...
	public function generate_kb_main_page() {
		...
		<div id="epkb-main-page-container" class="epkb-css-full-reset epkb-basic-template <?php echo method_exists( 'EPKB_Utilities', 'get_active_theme_classes' ) ? EPKB_Utilities::get_active_theme_classes( 'mp' ) : ''; ?>">
