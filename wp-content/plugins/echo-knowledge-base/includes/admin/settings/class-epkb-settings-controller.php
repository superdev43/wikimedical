...
class EPKB_Settings_Controller {
	...
	public function toggle_debug() {
		...
		EPKB_Utilities::ajax_verify_nonce_and_admin_permission_or_error_die( '_wpnonce_epkb_toggle_debug' );
	...
	public function enable_advanced_search_debug() {
		...
		// wp_die if nonce invalid or user does not have correct permission
		EPKB_Utilities::ajax_verify_nonce_and_admin_permission_or_error_die( '_wpnonce_epkb_enable_advanced_search_debug' );
